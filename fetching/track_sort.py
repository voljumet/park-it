...
def parse_opt(video_path, show_video):
    ...
    args = ['--source', video_path,'--classes', '2','--save-txt']

    if show_video:
        args.append('--show-vid')
...
def track_cars(video_path, threshold_1,threshold_2, smallest_boundingbox_w, smallest_boundingbox_h, show_video):
    # print(os.getcwd())
    # set path to video
    opt = parse_opt(video_path, show_video)
